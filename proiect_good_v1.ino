...
// What page to grab!
#define WEBSITE      "192.168.0.107"  //NOTE: CC3000 doesn't seem to like the default localhost address of 127.0.0.1 - need to enter actual IP
...
uint32_t ip = (192L << 24) | (168L<<16) | (0<<8) | 107;
